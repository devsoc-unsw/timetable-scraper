import { ClassChunk, ClassesByTerm, ClassWarnings } from "../../scraper-helpers/interfaces";
import { parseClassChunk } from "../chunk-scraper/class-scraper/ClassScraper";
 ...
 */
const getClassesByTerm = (courseClasses: ClassChunk[]): GetClassesByTermReturn => {
